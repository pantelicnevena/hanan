...
function tiles_scripts_styles() {
    ...
    if (!is_admin()) {
        ...
        wp_enqueue_script('material-design-js', get_template_directory_uri().'/js/material.min.js', array());
...
function wpb_add_google_fonts() {
    wp_register_style('wpb-googleFonts7', 'http://fonts.googleapis.com/css?family=Laila:700,600,500,400');
    wp_enqueue_style( 'wpb-googleFonts7');
}
