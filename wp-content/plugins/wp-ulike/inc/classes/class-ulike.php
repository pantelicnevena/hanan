...
if ( ! class_exists( 'wp_ulike' ) ) {
	...
	class wp_ulike{
		...
		public function get_template($id,$method,$liked,$num1,$num2){
			...
			return array(
			"like_img"			=> '<a data-ulike-id="'.$id.'" data-ulike-type="'.$method.'" data-ulike-status="'.$status.'" class="counter-link wp_ulike_btn"> <i class="fa fa-heart fa-fw text-danger" ></i> '.$counter.'<br><br>VOTE</a>',
