...
if ( ! function_exists( 'woocommerce_button_proceed_to_checkout' ) ) {
	...
	function woocommerce_button_proceed_to_checkout() {
		...
		?>
		<a href="<?php echo $checkout_url; ?>" class="alt wc-forward mdl-button mdl-js-button mdl-button--raised mdl-button--accent"><?php _e( 'Proceed to Checkout', 'woocommerce' ); ?></a>
		<?php
	}
}
